      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Tambah data Vaksins </p>
                  @if (session('status'))
        ...
        @endif
                 ...
                 <hr>
                  <div class="row">
                    <div class="col-md-12">
                      <form method="POST" action="{{ route('vaksin.store') }}">
                        @csrf
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label">Nama Vaksin</label>
                          <input type="text" name="nama_vaksins" class="form-control  @error('nama_vaksins') is-invalid @enderror" id="nama_vaksins" >
                          @error('nama_vaksins')
